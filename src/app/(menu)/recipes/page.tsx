        ...
        <div className="">
          <div className="">
            ...
            <div className="flex">
              ...
              <div className="prep-time my-auto flex w-fit gap-x-2">
                <svg
                  className="my-auto"
                  width="24"
                  height="24"
                ...
                <div className="my-auto">
                  <p className="text black text-xs font-medium">PREP TIME</p>
                  <p className="my-auto text-sm font-medium text-black text-opacity-60">
                    15 Minutes
                  </p>
                </div>
              </div>
              <div className="cook-time my-auto flex w-fit gap-x-2">
                <svg
                  className="my-auto"
                  width="24"
                  height="24"
                ...
                <div className="my-auto">
                  <p className="text black text-xs font-medium">COOK TIME</p>
                  <p className="my-auto text-sm font-medium text-black text-opacity-60">
                    15 Minutes
                  </p>
                </div>
