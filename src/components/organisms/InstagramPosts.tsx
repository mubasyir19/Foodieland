import { PostIG } from "@/services/data/postIG";
...
export default function InstagramPosts() {
  return (
    <section className="mt-20 w-full bg-gradient-to-t from-light-blue to-transparent p-20 px-5 md:px-10">
      ...
      <button className="mx-auto mt-16 flex gap-x-4 rounded-2xl bg-black px-6 py-4 text-white">
        <span className="my-auto text-sm">Visit Our Instagram</span>
        <svg
          width="23"
          height="22"
          viewBox="0 0 23 22"
